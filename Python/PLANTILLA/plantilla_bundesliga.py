...
ulrs=['https://www.resultados-futbol.com/plantilla/Bayern-Munchen', 'https://www.resultados-futbol.com/plantilla/Borussia-Dortmund',
...
csvfile="/home/gonzalo/Escritorio/TFG/PLANTILLA/plantilla_bundesliga_2019_2020.csv"
...
'https://www.resultados-futbol.com/plantilla/Bayer-Leverkusen','https://www.resultados-futbol.com/plantilla/Schalke-04',
'https://www.resultados-futbol.com/plantilla/Wolfsburg','https://www.resultados-futbol.com/plantilla/Sc-Freiburg',
'https://www.resultados-futbol.com/plantilla/Tsg-1899-Hoffenheim','https://www.resultados-futbol.com/plantilla/Stuttgart',
'https://www.resultados-futbol.com/plantilla/Hannover-96','https://www.resultados-futbol.com/plantilla/Eintracht-Frankfurt',
'https://www.resultados-futbol.com/plantilla/Hertha-Bsc','https://www.resultados-futbol.com/plantilla/Fc-Augsburg',
'https://www.resultados-futbol.com/plantilla/Mainz-Amat','https://www.resultados-futbol.com/plantilla/Fortuna-Dusseldorf',
'https://www.resultados-futbol.com/plantilla/Werder-Bremen','https://www.resultados-futbol.com/plantilla/Fc-Nurnberg']
...
csvfile="/home/gonzalo/Escritorio/TFG/PLANTILLA/plantilla_bundesliga_2018_2019.csv"
with open(csvfile,"w")as output:
	writer=csv.writer(output,lineterminator='\n')
	for val in lista:
		writer.writerow([val.temporada,val.equipo,val.dorsal,val.foto,val.nombre,val.posicion,val.edad,val.pais,val.altura,val.peso,val.goles,val.rojas,val.amarillas])
...
'https://www.resultados-futbol.com/plantilla/Hannover-96','https://www.resultados-futbol.com/plantilla/Eintracht-Frankfurt',
'https://www.resultados-futbol.com/plantilla/Hertha-Bsc','https://www.resultados-futbol.com/plantilla/Fc-Augsburg',
'https://www.resultados-futbol.com/plantilla/Mainz-Amat','https://www.resultados-futbol.com/plantilla/1-Fc-Koln',
'https://www.resultados-futbol.com/plantilla/Werder-Bremen','https://www.resultados-futbol.com/plantilla/Hamburger-Sv']
...
csvfile="/home/gonzalo/Escritorio/TFG/PLANTILLA/plantilla_bundesliga_2017_2018.csv"
with open(csvfile,"w")as output:
	writer=csv.writer(output,lineterminator='\n')
	for val in lista:
		writer.writerow([val.temporada,val.equipo,val.dorsal,val.foto,val.nombre,val.posicion,val.edad,val.pais,val.altura,val.peso,val.goles,val.rojas,val.amarillas])
...
'https://www.resultados-futbol.com/plantilla/Bayer-Leverkusen','https://www.resultados-futbol.com/plantilla/Schalke-04',
'https://www.resultados-futbol.com/plantilla/Wolfsburg','https://www.resultados-futbol.com/plantilla/Sc-Freiburg',
'https://www.resultados-futbol.com/plantilla/Tsg-1899-Hoffenheim','https://www.resultados-futbol.com/plantilla/Fc-Ingolstadt-04',
'https://www.resultados-futbol.com/plantilla/Darmstadt-98','https://www.resultados-futbol.com/plantilla/Eintracht-Frankfurt',
'https://www.resultados-futbol.com/plantilla/Hertha-Bsc','https://www.resultados-futbol.com/plantilla/Fc-Augsburg',
'https://www.resultados-futbol.com/plantilla/Mainz-Amat','https://www.resultados-futbol.com/plantilla/1-Fc-Koln',
'https://www.resultados-futbol.com/plantilla/Werder-Bremen','https://www.resultados-futbol.com/plantilla/Hamburger-Sv']
...
csvfile="/home/gonzalo/Escritorio/TFG/PLANTILLA/plantilla_bundesliga_2016_2017.csv"
with open(csvfile,"w")as output:
	writer=csv.writer(output,lineterminator='\n')
	for val in lista:
		writer.writerow([val.temporada,val.equipo,val.dorsal,val.foto,val.nombre,val.posicion,val.edad,val.pais,val.altura,val.peso,val.goles,val.rojas,val.amarillas])
