...
copa_del_rey=[]
with open('calendario_copa_del_rey.csv') as csvfile:
...
plantilla_2019_2020=[]
with open('plantilla_españa_2019_2020.csv') as csvfile:
...
plantilla_2018_2019=[]
with open('plantilla_españa_2018_2019.csv') as csvfile:
	reader_plantilla = csv.DictReader(csvfile)
	for plantilla in reader_plantilla:
		j=jugador()
		j.equipo=plantilla['plantilla_equipo']
...
plantilla_2017_2018=[]
with open('plantilla_españa_2017_2018.csv') as csvfile:
	reader_plantilla = csv.DictReader(csvfile)
	for plantilla in reader_plantilla:
		j=jugador()
		j.equipo=plantilla['plantilla_equipo']
...
plantilla_2016_2017=[]
with open('plantilla_españa_2016_2017.csv') as csvfile:
	reader_plantilla = csv.DictReader(csvfile)
	for plantilla in reader_plantilla:
		j=jugador()
		j.equipo=plantilla['plantilla_equipo']
...
partidos=[]
with open('partidos.csv') as csvfile:
...
with open('alineacion_2019_2020.csv') as csvfile:
...
with open('alineacion_2018_2019.csv') as csvfile:
	reader_alineacion = csv.DictReader(csvfile)
	for alineacion in reader_alineacion:
		a=objeto_alineacion()
		a.temporada=alineacion['Temporada']
...
with open('alineacion_2017_2018.csv') as csvfile:
	reader_alineacion = csv.DictReader(csvfile)
	for alineacion in reader_alineacion:
		a=objeto_alineacion()
		a.temporada=alineacion['Temporada']
...
with open('alineacion_2016_2017.csv') as csvfile:
	reader_alineacion = csv.DictReader(csvfile)
	for alineacion in reader_alineacion:
		a=objeto_alineacion()
		a.temporada=alineacion['Temporada']
...
clasificaciones=[]
with open('clasificacion.csv') as csvfile:
...
csvfile="/home/gonzalo/Escritorio/TFG/DATOS-ALVARO/ESPAÑA/DATOS/datos_natalia.csv"
