...
fa_cup=[]
with open('calendario_fa_cup.csv') as csvfile:
...
carabao=[]
with open('calendario_carabao.csv') as csvfile:
	reader_copa = csv.DictReader(csvfile)
	for copa in reader_copa:
		c=objeto_competiciones()
		c.fecha=copa['copa_fecha']
...
plantilla_2019_2020=[]
with open('plantilla_premier_2019_2020.csv') as csvfile:
...
plantilla_2018_2019=[]
with open('plantilla_premier_2018_2019.csv') as csvfile:
	reader_plantilla = csv.DictReader(csvfile)
	for plantilla in reader_plantilla:
		j=jugador()
		j.equipo=plantilla['plantilla_equipo']
...
plantilla_2017_2018=[]
with open('plantilla_premier_2017_2018.csv') as csvfile:
	reader_plantilla = csv.DictReader(csvfile)
	for plantilla in reader_plantilla:
		j=jugador()
		j.equipo=plantilla['plantilla_equipo']
...
plantilla_2016_2017=[]
with open('plantilla_premier_2016_2017.csv') as csvfile:
	reader_plantilla = csv.DictReader(csvfile)
	for plantilla in reader_plantilla:
		j=jugador()
		j.equipo=plantilla['plantilla_equipo']
...
partidos=[]
with open('partidos_premier.csv') as csvfile:
...
with open('alineacion_premier_2019_2020.csv') as csvfile:
...
with open('alineacion_premier_2018_2019.csv') as csvfile:
	reader_alineacion = csv.DictReader(csvfile)
	for alineacion in reader_alineacion:
		a=objeto_alineacion()
		a.temporada=alineacion['Temporada']
...
with open('alineacion_premier_2017_2018.csv') as csvfile:
	reader_alineacion = csv.DictReader(csvfile)
	for alineacion in reader_alineacion:
		a=objeto_alineacion()
		a.temporada=alineacion['Temporada']
...
with open('alineacion_premier_2016_2017.csv') as csvfile:
	reader_alineacion = csv.DictReader(csvfile)
	for alineacion in reader_alineacion:
		a=objeto_alineacion()
		a.temporada=alineacion['Temporada']
...
clasificaciones=[]
with open('clasificacion_premier.csv') as csvfile:
...
csvfile="/home/gonzalo/Escritorio/TFG/DATOS-ALVARO/PREMIER/DATOS/datos_natalia_premier.csv"
	...
	for equipo in clasificaciones:
		...
		if jor>1:
			try:
				...
				print(dato_equipo+" "+dato_jornada)
		...
		for p in alineacion_actual:
			if p.gol==max_goles and p.cambio!="":
				dato_dictomico_cambio_max_goleador=1
			if p.asistencia==max_asistencias and p.cambio!="":
