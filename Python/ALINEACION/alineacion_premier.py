...
csvfile="/home/gonzalo/Escritorio/TFG/ALINEACION/alineacion_premier_2019_2020.csv"
...
csvfile="/home/gonzalo/Escritorio/TFG/ALINEACION/alineacion_premier_2018_2019.csv"
with open(csvfile,"w")as output:
	writer=csv.writer(output,lineterminator='\n')
	for val in lista:
		writer.writerow([val.temporada,val.jornada,val.equipo,val.jugador,val.estado,val.cambio,val.gol,val.amarilla,val.roja,val.asistencia,val.lesion])
...
csvfile="/home/gonzalo/Escritorio/TFG/ALINEACION/alineacion_premier_2017_2018.csv"
with open(csvfile,"w")as output:
	writer=csv.writer(output,lineterminator='\n')
	for val in lista:
		writer.writerow([val.temporada,val.jornada,val.equipo,val.jugador,val.estado,val.cambio,val.gol,val.amarilla,val.roja,val.asistencia,val.lesion])
...
csvfile="/home/gonzalo/Escritorio/TFG/ALINEACION/alineacion_premier_2016_2017.csv"
with open(csvfile,"w")as output:
	writer=csv.writer(output,lineterminator='\n')
	for val in lista:
		writer.writerow([val.temporada,val.jornada,val.equipo,val.jugador,val.estado,val.cambio,val.gol,val.amarilla,val.roja,val.asistencia,val.lesion])
